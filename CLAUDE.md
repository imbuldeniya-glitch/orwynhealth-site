...
- Documents and pages are edited in place, never duplicated. Change the existing file rather than creating a second copy, a "-v2", or a parallel version alongside it.
- Nothing is committed or pushed without Dr Imbuldeniya's explicit sign-off in the current conversation. This restates the rule at the top of this file and in Process above; it is the one that matters most.
